...
export class BattleAgent {
    ...
    async getActiveBattles(contractType = 'range') {
    ...
    async getBattlesReadyToResolve(contractType = 'range') {
    ...
    // Get battle details
    async getBattle(battleId, contractType = 'range') {
        const address = contractType === 'range' ? config.rangeVaultAddress : config.feeVaultAddress;
        const abi = contractType === 'range' ? RangeVaultABI : FeeVaultABI;
        try {
            const result = await this.publicClient.readContract({
    ...
    // Get battle status
    async getBattleStatus(battleId, contractType = 'range') {
        const address = contractType === 'range' ? config.rangeVaultAddress : config.feeVaultAddress;
        const abi = contractType === 'range' ? RangeVaultABI : FeeVaultABI;
        try {
            const result = await this.publicClient.readContract({
    ...
    async getTimeRemaining(battleId, contractType = 'range') {
        const address = contractType === 'range' ? config.rangeVaultAddress : config.feeVaultAddress;
        const abi = contractType === 'range' ? RangeVaultABI : FeeVaultABI;
        try {
            const result = await this.publicClient.readContract({
    ...
    // Settle a battle
    async settleBattle(battleId, contractType = 'range') {
        const address = contractType === 'range' ? config.rangeVaultAddress : config.feeVaultAddress;
        const abi = contractType === 'range' ? RangeVaultABI : FeeVaultABI;
