        ...
        switch (command) {
            ...
            case 'serve': {
                ...
                try {
                    ...
                    const routes = await lifi.getSwapRoutes(8453, 1, '0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913', '0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48', '50000000', agent.getAddress());
            ...
            case 'routes': {
                ...
                try {
                    const routes = await lifi.getSwapRoutes(fromChain, toChain, '0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913', '0xaf88d065e77c8cC2239327C5EDb3A432268e5831', // USDC on Arbitrum
                    amount, agent.getAddress());
                    if (routes.length > 0) {
