...
export const config = {
  ...
  // Contract Addresses
  rangeVaultAddress: process.env.RANGE_VAULT_ADDRESS as `0x${string}`,
  feeVaultAddress: process.env.FEE_VAULT_ADDRESS as `0x${string}`,
  poolManager: process.env.POOL_MANAGER as `0x${string}`,
  positionManager: process.env.POSITION_MANAGER as `0x${string}`,
